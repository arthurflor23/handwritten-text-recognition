...
if __name__ == '__main__':
    ...
    parser.add_argument('--image-shape', default=[64, 2048, 1], nargs=3, type=int, help='Define image shape (h, w, c)')
    parser.add_argument('--char-width', default=16, type=int, help='Define character width for normalization')
