...
if __name__ == '__main__':
    ...
    parser.add_argument('--plateau-patience', default=15, type=int, help='Epochs before recognizing a plateau')
    parser.add_argument('--patience', default=20, type=int, help='Epochs without improvement to stop')
