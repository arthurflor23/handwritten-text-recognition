...
class RecognitionModel(BaseRecognitionModel):
    ...
    def build_model(self):
        ...
        encoder = tf.keras.layers.Conv2D(filters=16,
                                         ...
                                         strides=(1, 1),
                                         padding='same',
                                         kernel_initializer='orthogonal')(encoder_input)
        ...
        encoder = GatedConv2D(filters=16,
                              ...
                              strides=(1, 1),
                              padding='same',
                              kernel_initializer='orthogonal')(encoder)
        ...
        encoder = tf.keras.layers.Dense(units=256, kernel_initializer='orthogonal')(encoder)
