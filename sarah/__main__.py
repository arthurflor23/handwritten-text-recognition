...
if __name__ == '__main__':
    ...
    parser.add_argument('--elastic', default=(0.33, 13), nargs='+', type=float, help='Elastic deformation settings')
    ...
    parser.add_argument('--shear', default=(0.33, 30), nargs='+', type=float, help='Shearing settings')
