...
if __name__ == '__main__':
    ...
    parser.add_argument('--finished-runs', default=False, action='store_true', help='Only finished runs')
    ...
    parser.add_argument('--elastic', default=None, nargs=2, type=float, help='Elastic deformation settings')
    parser.add_argument('--perspective', default=None, nargs=2, type=float, help='Perspective distortion settings')
    parser.add_argument('--mixup', default=None, nargs=2, type=float, help='Mixup settings')
    parser.add_argument('--shear', default=None, nargs=2, type=float, help='Shearing settings')
    parser.add_argument('--scale', default=None, nargs=2, type=float, help='Scaling settings')
