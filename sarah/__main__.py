...
if __name__ == '__main__':
    ...
    parser.add_argument('--erode', default=(1/3, 3), nargs='+', type=float, help='Erosion settings')
    parser.add_argument('--dilate', default=None, nargs='+', type=float, help='Dilation settings')
    parser.add_argument('--elastic', default=(1/3, 31), nargs='+', type=float, help='Elastic deformation settings')
    parser.add_argument('--perspective', default=(2/3, 5/6), nargs='+', type=float, help='Perspective settings')
    parser.add_argument('--mixup', default=None, nargs='+', type=float, help='Mixup settings')
    parser.add_argument('--shear', default=(1/3, 1/9), nargs='+', type=float, help='Shearing settings')
    parser.add_argument('--scale', default=(1/3, 1/9), nargs='+', type=float, help='Scaling settings')
    parser.add_argument('--rotate', default=(1/3, 1/9), nargs='+', type=float, help='Rotation settings')
