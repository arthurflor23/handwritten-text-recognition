...
if __name__ == '__main__':
    ...
    parser.add_argument('--shift-y', default=(0.33, 0.1), nargs='+', type=float, help='Vertical shift settings')
    parser.add_argument('--shift-x', default=(0.33, 0.1), nargs='+', type=float, help='Horizontal shift settings')
