...
class RecognitionModel(BaseRecognitionModel):
    ...
    def build_model(self):
        ...
        encoder = SelfAttention(downrate=4, dropout=0.1)(encoder)
        encoder = tf.keras.layers.Dropout(rate=0.1)(encoder)
        ...
        encoder = SelfAttention(downrate=2, dropout=0.1)(encoder)
        encoder = tf.keras.layers.Dropout(rate=0.1)(encoder)
        ...
        encoder = SelfAttention(downrate=1, dropout=0.1)(encoder)
